---
name: start-nrepl
description: Start an nREPL server in the background. Use this when the user needs a REPL running for code evaluation, testing, or interactive development.
---
